...
export function LockedDark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="49" viewBox="0 0 48 49" fill="none" {...props}>
      <g filter="url(#filter0_b_28_22866)">
        <rect y="0.577148" width="48" height="48" rx="24" fill="#2D2C2E" />
        <path
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_28_22866" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_28_22866" result="shape" />
        </filter>
      </defs>
    </svg>
  );
